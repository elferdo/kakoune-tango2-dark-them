...
set-face global LineNumbers "%opt{dimmed_background},%opt{background}"
...
set-face global StatusLine "%opt{aluminium1},%opt{aluminium6}"
set-face global StatusLineMode "%opt{background},%opt{chameleon_medium}"
set-face global StatusLineInfo "%opt{plum_medium},%opt{aluminium2}"
